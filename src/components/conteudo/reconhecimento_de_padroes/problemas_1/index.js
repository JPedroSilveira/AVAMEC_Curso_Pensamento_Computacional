...
const Problemas = () => (
    <div>
        ...
        <div className="imagem-centralizada">
            <img src={Tangram1} className="figura" alt="Tangram montado com sete peças coloridas em formato de lozango."/>
        ...
        <div className="imagem-centralizada">
            <img src={Tangram2} className="figura" alt="Tangram desmontado feito com sete peças coloridas."/>
