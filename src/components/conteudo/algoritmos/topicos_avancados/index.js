...
const TopicosAvancados = () => (
    <div>
        ...
        <h3>ALG 10:  ALGORITMO PRINCIPAL</h3>
        <ol>
        ...
        <h3>ALG 11: ORDENAÇÃO DOS CILINDROS POR PESO</h3>
        <ol>
        ...
        <h3>ALG 12: ESCOLHER O CILINDRO MAIS PESADO DE UMA COLEÇÃO</h3>
        <ol>
        ...
        <h3>ALG 13: PREENCHER O COMPARTILHAMENTO DE CARGAS</h3>
        <ol>
        ...
        <iframe width="560" height="315" src="https://www.youtube.com/embed/cVMKXKoGu_Y" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe><br/>
        Ordenando Cilindros de diferentes pesos:
