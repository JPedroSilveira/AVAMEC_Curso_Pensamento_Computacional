            ...
            questions: [
                {
                    ...
                    title: "A3: <strong>Aprendizagem ativa - o método JIGSAW II (Slavin, 1955) (Pereira, 2003)</strong> - A lista de ações, a seguir, descreve um método (Algoritmo) de aprendizagem cooperativa, denominado <strong>JIGSAW II</strong>.",
                    statement: "<p><strong>O Método JIGSAW II</strong> (Slavin, 1955) (Pereira, 2003)</p><ul><li>Escolha um texto que trate do assunto que pretende que os alunos estudem, a partir da leitura de um texto-base;</li><li>Divida o texto-base em trechos que representem um subtópico do tema a ser estudado;</li><li>[Grupos de Especialistas] Divida o grupo em subgrupos na mesma quantidade de subtópicos e atribua a cada subgrupo a responsabilidade sobre um dos subtópicos;<ul><li>Cada subgrupo deve ler o texto completo com ênfase no subtópico de sua responsabilidade e, a seguir, pesquisar para aprofundar conhecimento sobre seu subtópico;</li></ul></li><li>[Grupos Gerais] Forme novos subgrupos, onde cada um deles deve ter um especialista  de cada subtópico;<ul><li>Cada grupo deve buscar entender o tema como um todo, a partir da contribuição de cada especialista, ou seja o especialista deve explicar para os demais participantes o tema que aprofundou no estudo da etapa anterior;</li></ul></li><li>[Grupos de Especialistas] Os especialistas voltam aos seus grupos de origem para debater o tema geral;</li><li>Avalie o conhecimento construído pelos participantes com respeito ao tema como um todo.</li></ul><br /><br /><p>Qual das afirmativas parece mais adequada para descrever o método?</p>",
                    options: [
                        {
                            value: "0",
                            key: "1",
