    ...
    <div>
        ...
        <CenterBox>
            <div className="boxed algorithms">
                <p className="title"><strong>Algoritmo 03 <br/> Iniciação - Do acordar até chegar no local de trabalho </strong> </p>
        ...
        <CenterBox>
            <div className="boxed algorithms">
                <p className="title"><strong>Algoritmo 04 <br/> Iniciação - Do acordar até chegar no local de trabalho </strong> </p>
                <div className="nivel-1">
                    <span className="textdarkgreen">Após o barulho do despertador: </span>
                    <div className="subnivel">
                        <ol>
