    ...
    <div>
        ...
        <CenterBoxContainer>
            <Box backgroundColor={Color.BLUE_BOX}>
                <p><span className="textred">enquanto</span> &ldquo;<span className="textblue">express&atilde;o</span>&rdquo; <span className="textred">fa&ccedil;a</span> &ldquo;lista de a&ccedil;&otilde;es&rdquo;</p>
            </Box>
        </CenterBoxContainer>
