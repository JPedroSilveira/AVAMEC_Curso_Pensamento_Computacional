...
class AtividadeComplementar extends React.Component {
    ...
    generateActivity = () => {
        return {
            id: "atividade_completamentar_exemplos_algoritmos_um",
            unitId: this.props.unitId,
            statement: "<strong>AC1</strong>: Apresente até 3 situações-problema, preferencialmente de sua área de interesse, nas quais você identifica a possibilidade de utilização do pilar “algoritmo” do pensamento  computacional, para apoiar a elaboração de soluções. Em cada caso, justifique o uso e argumente sobre sua importância.",
            ...
            questions: [
                ...
                {
                    title: "A forma de uso do Pilar \"Algoritmo\"",
                    maxAnswerLength: 400
                },
                {
