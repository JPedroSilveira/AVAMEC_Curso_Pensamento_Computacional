            ...
            questions: [
                {
                    ...
                    options: [
                        ...
                        },
                        {
                            value: "0",
                            key: "4",
                            text: "Se nenhum dos produtos de sua lista forem encontrados no supermercado, você chegará ao caixa com seu carrinho vazio e, portanto, nada terá que pagar. Ou seja, as ações “dirija-se ao caixa”  e “pague a conta”  são desnecessárias para esse caso e os Passos 3 e 4 do nosso algoritmo poderiam ser substituídos pelo trecho a seguir. < /br>3. Se o carrinho de compras está vazio< /br>     então< /br>          devolva o carrinho< /br>     senão< /br>          dirija-se ao caixa< /br>          pague a conta",
