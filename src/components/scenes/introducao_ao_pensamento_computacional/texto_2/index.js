    ...
    <div>
        ...
        <CenterBoxContainer>
            <Box backgroundColor={Color.GRAY_BOX}>
                ...
                <p>O Sr. Jos&eacute; saiu do trabalho por volta das 19 horas. O dia foi longo, muitas reuni&otilde;es, muitos processos para despachar, muito clientes para atender, um dia cansativo. &Agrave; noite ainda pretendia concluir a leitura de alguns processos que deveria despachar no dia seguinte.</p>
                <p>No caminho de casa, ao se aproximar de um supermercado, imaginou que talvez precisasse fazer algumas compras. Olhou o rel&oacute;gio e viu que ainda tinha um tempinho sobrando.</p>
