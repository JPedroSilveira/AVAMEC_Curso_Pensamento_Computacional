...
const Aplicacoes = () => (
    <div>
        ...
        <p>Guardadas as devidas proporções, o corpo humano poderia ser analisado segundo alguns de seus sistemas (Figura 2) - nervoso, digestivo, circulatório, muscular etc - e qualquer problema de saúde, afetando um ou mais destes sistemas, poderia ser identificado através de um processo análogo (embora muito mais rigoroso) ao citado acima.</p>
        ...
        <Image rc={IMGDecomposicao4} alt="Foto de um desfile de carnaval no Rio de Janeiro com a arquibancada lotada e na rua passando diversos carros alegórcos.">
            <p> 
