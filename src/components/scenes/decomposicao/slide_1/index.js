...
import BorderOne from '../../../../images/content/decomposicao/border-one.svg'
import BorderTwo from '../../../../images/content/decomposicao/border-two.svg'

class Slide1 extends React.Component {
    render() {
        return (
            <Fragment>
                <TextStandardBox image={BorderOne}>
                ...
                <Image marginTop="50px" marginBottom="50px" height="auto" width="auto" src={GreekMap}/>
                <TextStandardBox marginBottom="100px" image={BorderTwo}>
