...
import IntroFour from '../../../../images/content/decomposicao/info-four.svg'

class Slide5 extends React.Component {
    render() {
        return (
            <Fragment>
                <Image marginTop="100px" marginBottom="-100px" height="auto" width="700px" src={IntroFive} />
                <TextStandardBox>
                ...
                <Image marginBottom="-100px" marginTop="50px" height="auto" width="700px" src={IntroFour} />
            </Fragment>
        )
    }
}
