...
import Problem1Image from '../../../../images/content/reconhecimento_de_padroes/loading.png'
import Problem2Image from '../../../../images/content/reconhecimento_de_padroes/loading.png'
import Problem3Image from '../../../../images/content/reconhecimento_de_padroes/loading.png'

class Slide6 extends React.Component {
    render() {
        return (
            <Fragment>
                <Image marginTop="100px" marginBottom="50px" height="auto" width="700px" src={IntroSix} />
                <StandardBox>
