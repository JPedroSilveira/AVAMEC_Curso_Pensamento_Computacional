...
class AtividadeComplementar extends React.Component {
    ...
    generateActivity = () => {
        return {
            ...
            statement: "<strong>AC1:</strong> Apresente até 3 situações-problema, preferencialmente de sua área de interesse, onde você identifica a possibilidade de utilização deste pilar do pensamento  computacional, para apoiar a elaboração de soluções. Em cada caso, justifique o uso e argumente sobre sua importância.",
